      ...
      <?php foreach ($result as $data) : ?>
        <tr class="hover:bg-gray-100 group">
          ...
          <td class="p-4 space-x-2 whitespace-nowrap">
            <button type="button" data-view-button data-code="<?= $data['dept_code']; ?>" data-name="<?= $data['dept_name']; ?>" data-desc="<?= $data['dept_desc']; ?>" class="btn-gray">
            ...
            <button type="button" data-edit-button data-id="<?= $data['dept_id']; ?>" data-code="<?= $data['dept_code']; ?>" data-name="<?= $data['dept_name']; ?>" data-desc="<?= $data['dept_desc']; ?>" class="btn-cyan">
            ...
            <button type="button" data-id="<?= $data['dept_id']; ?>" data-delete-button class="btn-red">
              <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
