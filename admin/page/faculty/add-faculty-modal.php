<div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto bg-gray-900/50 top-4 md:inset-0 h-modal sm:h-full" id="add-faculty-modal" aria-modal="true" role="dialog">
    ...
    <div class="relative bg-white rounded-lg shadow">
      ...
      <form action="../includes/faculty.inc.php" method="post">
        ...
        <div class="items-center p-6 border-t border-gray-200 rounded-b">
          <button type="submit" name="add" class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add faculty</button>
        </div>
      </form>
    </div>
  </div>
