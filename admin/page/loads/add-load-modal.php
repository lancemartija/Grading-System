<div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto bg-gray-900/50 top-4 md:inset-0 h-modal sm:h-full" id="add-load-modal" aria-modal="true" role="dialog">
            ...
            <tbody class="bg-white divide-y divide-gray-200 ">
              <?php foreach ($options as $data) : ?>
                <tr class="hover:bg-gray-100 group">
                  <!-- add if condition to check whether 
                  the class id for this subject exists or not 
                  in order to disable the checkbox -->
                  <td class="w-4 p-4">
                    <div class="flex items-center">
                      <input type="checkbox" name="..." class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-cyan-200">
