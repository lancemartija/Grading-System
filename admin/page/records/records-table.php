      ...
      <?php foreach ($result as $data) : ?>
        <tr class="hover:bg-gray-100 group">
          ...
          <td class="p-4 space-x-2 whitespace-nowrap">
            <a href="subject-list.php?studentnumber=<?= $studentnumber; ?>&course=<?= $data['sy_level']; ?>" class="btn-yellow">
          ...
          <td class="p-4 space-x-2 text-right whitespace-nowrap">
            ...
            <button type="button" data-edit-button data-id="<?= $data['sy_id']; ?>" data-sem="<?= $data['sy_sem']; ?>" data-status="<?= $data['sy_status']; ?>" data-level="<?= $data['sy_level']; ?>" data-year="<?= $data['sy_ay']; ?>" class="btn-cyan">
