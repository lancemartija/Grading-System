      ...
      <?php foreach ($result as $data) : ?>
        <tr class="hover:bg-gray-100 group">
          ...
          <td class="p-4 space-x-2 text-right whitespace-nowrap">
            <button type="button" data-edit-button data-id="<?= $data['sy_id']; ?>" data-number="<?= $data['student_number']; ?>" data-name="<?= $data['student_name']; ?>" data-status="<?= $data['sy_status']; ?>" data-level="<?= $data['sy_level']; ?>" data-year="<?= $data['sy_ay']; ?>" class="btn-cyan">
