      ...
      <div class="items-center justify-between block p-4 bg-white border-b border-gray-200 sm:flex">
        <div class="w-full mb-1">
          <div class="mb-4">
              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li>
                  <div class="flex items-center">
                    ...
                    <a href="faculty.php" class="ml-1 text-sm font-medium text-gray-700 capitalize hover:text-gray-900 md:ml-2">Faculties</a>
                  </div>
                </li>
                <li>
                  <div class="flex items-center">
            ...
            <h1 class="flex items-center text-xl font-semibold text-gray-900 capitalize sm:text-2xl">List of Students <span class="inline-flex items-center px-3 py-1.5 ml-2 text-sm font-medium text-center text-white bg-teal-500 rounded-2xl shadow-sm"><?= $result[0]['subj_name'] ?></span></h1>
          </div>
          <div class="sm:flex">
