                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2">Students</a>
                    </div>
                  </li>
                  <li>
                    <div class="flex items-center">
              ...
              <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0">
                <form class="flex lg:pr-2" action="#" method="get">
                  ...
                  <div class="relative mr-2 lg:w-64 xl:w-96">
                    <input type="text" name="search" class="bg-gray-50 border border-gray-300 text-gray-900 focus:outline-none sm:text-sm rounded-lg focus:ring-gray-200 focus:ring-4 block w-full p-2.5" placeholder="Search for students" required>
                  </div>
                ...
                <div class="flex pl-0 mt-3 space-x-1 sm:pl-2 sm:mt-0">
                  <a href="students.php" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 sm:w-auto">
