              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li>
                  <div class="flex items-center">
                    ...
                    <a href="#" class="ml-1 text-sm font-medium text-gray-700 capitalize hover:text-gray-900 md:ml-2">Class</a>
                  </div>
                </li>
              </ol>
            </nav>
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">Class</h1>
          </div>
          <div class="sm:flex">
