    ...
    <div class="relative bg-white rounded-lg shadow">
      ...
      <form action="../includes/subjects.inc.php" method="post">
        ...
        <div class="items-center p-6 border-t border-gray-200 rounded-b">
          <button type="submit" name="add" class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add subject</button>
        </div>
      </form>
    </div>
  </div>
