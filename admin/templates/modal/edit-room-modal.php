    ...
    <div class="relative bg-white rounded-lg shadow">
      ...
      <form action="../includes/rooms.inc.php" method="post">
        ...
        <div class="p-6 space-y-6">
          <div class="grid grid-cols-6 gap-6">
            <div class="col-span-4 sm:col-span-3">
              <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Code</label>
        ...
        <div class="items-center p-6 border-t border-gray-200 rounded-b">
          <button type="submit" name="edit" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Update rooms</button>
        </div>
      </form>
    </div>
  </div>
