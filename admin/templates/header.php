    ...
    <div class="sm:flex">
      <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0">
        ...
        <div class="flex pl-0 mt-3 space-x-1 sm:pl-2 sm:mt-0">
          <a href="<?= $searchlink ?>" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 sm:w-auto">
      ...
      <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
        <button type="button" data-add-button class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white bg-green-600 rounded-lg <?= (empty($options) && $page == 'List of Loads') ? 'opacity-70' : 'hover:bg-green-700'; ?> focus:ring-4 focus:ring-green-500 focus:ring-opacity-50 sm:w-auto" <?= (empty($options) && $page == 'List of Loads') ? 'disabled' : ''; ?>>
