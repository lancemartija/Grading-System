  ...
  <div class="w-full mb-1">
    ...
    <div class="sm:flex">
      ...
      <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
        <button type="button" data-add-button class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white bg-green-600 rounded-lg <?= (empty($options) && $page == 'List of Loads') ? '' : 'hover:bg-green-700 '; ?> focus:ring-4 focus:ring-green-500 focus:ring-opacity-50 sm:w-auto" <?= (empty($options) && $page == 'List of Loads') ? 'disabled' : ''; ?>>
