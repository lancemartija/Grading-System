<div class="items-center justify-between block p-4 bg-white border-b border-gray-200 sm:flex">
  <div class="w-full mb-1">
    <div class="mb-4">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2">
          ...
          <li>
            <div class="flex items-center">
              ...
              <a href="#" class="ml-1 text-sm font-medium text-gray-700 capitalize hover:text-gray-900 md:ml-2"><?= $breadcrumb; ?></a>
            </div>
          </li>
          <li>
            <div class="flex items-center">
      ...
      <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">All <?= $page; ?></h1>
    </div>
    <div class="sm:flex">
      <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0">
        ...
        <div class="flex pl-0 mt-3 space-x-1 sm:pl-2 sm:mt-0">
          <a href="<?= $link ?>.php" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 sm:w-auto">
