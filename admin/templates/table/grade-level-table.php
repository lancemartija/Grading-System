      ...
      <?php foreach ($result as $data) : ?>
        <tr class="hover:bg-gray-100 group">
          ...
          <td class="p-4 space-x-2 whitespace-nowrap">
            ...
            <button type="button" data-id="<?= $data['course_id']; ?>" data-delete-button class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300">
              <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
