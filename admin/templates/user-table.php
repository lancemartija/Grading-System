      ...
      <?php foreach ($result as $data) : ?>
        <tr class="hover:bg-gray-100 group">
          ...
          <td class="p-4 space-x-2 whitespace-nowrap">
            <button type="button" data-edit-button data-id="<?= $data['account_id']; ?>" data-fname="<?= $data['account_firstname']; ?>" data-lname="<?= $data['account_lastname']; ?>" data-email="<?= $data['account_email']; ?>" data-username="<?= $data['account_username']; ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200">
            ...
            <button type="button" data-delete-button class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300">
              <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
